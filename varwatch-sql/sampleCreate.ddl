...
create table auth_user (id integer generated by default as identity, active boolean, address varchar(255), city varchar(255), country varchar(255), email varchar(255), first_name varchar(255), institution varchar(255), last_report timestamp, last_name varchar(255), password varchar(255), phone varchar(255), postal_code varchar(255), pw_source varchar(255), pw_timestamp timestamp, registration_form blob, report_schedule varchar(255), status varchar(255), primary key (id))
...
create table ref_database (id bigint generated by default as identity, assembly varchar(255), implementation varchar(255), is_active boolean, timestamp timestamp, name varchar(255), path varchar(255), updated boolean, version varchar(255), primary key (id))
