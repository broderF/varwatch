...
//    private MatchSQL match;
    ...
    public VariantStatusBuilder withStatus(VariantStatus status) {
    ...
    public VariantStatusBuilder withStatusVW(VWStatus status, String rawVariant, String variantHash, DatasetVWSQL dataset, UserSQL user) {
    ...
    public VariantStatusSQL buildSql() {
        VariantStatusSQL variantStatus = new VariantStatusSQL();
    ...
    public VariantStatusBuilder withStatusSQL(VariantStatusSQL lastStatus) {
...
//    }
    ...
    public VariantStatusBuilder withVariantMatch(MatchVariantSQL matchVariant) {
